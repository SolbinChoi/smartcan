...
public class AdverCenterController {
	...
	//고객센터 게시물 리스트
		...
		public String write(@ModelAttribute AdverBoardVo vo, 
				HttpSession session, 
		...
		public String delete(HttpSession session, 
			...
			//게시물 첨부파일 삭제
			adverservice.delete(group_no,order_no);
		...
		public String viewfrom(HttpSession session,
			...
			Long userno = DeterminVo.getUser_no();
			
			//게시물의 정보 얻기 (no,title,content)
		...
		public String reply(
			...
			int groupOrderno=vo.getOrder_no()+1;
			int groupNo=vo.getGroup_no();
			
			vo.setDepth(depth);
			vo.setOrder_no(groupOrderno);
