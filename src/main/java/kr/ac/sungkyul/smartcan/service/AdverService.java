...
public class AdverService {
	...
	public void write(AdverBoardVo vo, MultipartFile file) throws Exception {
		...
		// 2. 그룹넘버 정보 얻어오기
		int groupno = vo1.getGroup_no();
		int orderno = vo1.getOrder_no();
		...
		// 6. path 경로 정하기
		String path = "C:\\Users\\S401-18\\solworkspace\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp2\\wtpwebapps\\smartcan\\assets\\images\\adver";

		// 7. 이미지 URL
		String imageurl = "/smartcan/assets/images/adver/" + saveName;
		...
		AttachFileAdVO.setImageurl(imageurl);
	...
	public void delete(int group_no, int order_no) {
		adverdao.delete(group_no, order_no);
	}
	...
	public void reply(AdverBoardVo vo, MultipartFile file) throws Exception {
		...
		// 2. 그룹 정보 얻기
		AdverBoardVo vo1 = adverdao.get(no);
		int groupno = vo1.getGroup_no(); // 그룹넘버 정보 얻어오기
		int orderno = vo1.getOrder_no();
