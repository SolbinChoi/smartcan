			...
			<div class="copy">
				<div class="copy_menu">
					<ul>
						...
						<li><a href="/gscvs/ko/footer/member-terms">GS리테일 멤버십(GS&amp;POINT) 회원약관</a></li>
						<li><a href="#" onclick="javascript:layer_open_footer('layerFooter-email', this);">이메일무단수집거부</a></li>
						<li><a href="/gscvs/ko/about-gs25/map">오시는길</a></li>
						<li class="bold"><a href="http://www.gsretail.com/gsretail/ko/corporation/jeongdo-management/system/report">정도경영/파트너사 목소리</a></li>
						<li class="bold"><a href="http://www.gsretail.com/gsretail/ko/corporation/jeongdo-management/system/report">CEO에게 말한다</a></li>
					</ul>
				</div>
				<div class="copy_txt">
					<p>
					주소 : 경기도 안양시 만안구(안양6동 성결대학교) | 대표이사 : 최솔빈 | 사업자등록번호 : 010-9428-0237 | 개인정보보호 책임 : 최형민</p>
					<p>
					GS리테일 <a href="javascript:void(0);" onclick="$.goMantoMan();">1:1 문의</a> | SmartCan(무료)031-467-8341 | GS수퍼마켓, GSiSuper(무료) 080-345-7700 | GSiSuper <a href="http://www.gsisuper.com/eretail.voc.qnaList.dev" target="_blank" title="새창열림">1:1문의</a></p>
					<p>
					Copyright 2015 GSRetail. Co. Ltd., ALL Right Reserved.</p>
				</div>
			</div>
			<div class="copy_logo">
				<img src="http://hpimg.gsretail.com/_ui/desktop/common/images/gscvs/common/ft_logo.gif" alt="GS25">
			</div>
				<ul class="ft_banner">
				<li><a href="http://www.webwatch.or.kr/Situation/WA_Situation.html?MenuCD=110" target="_blank" title="국가 공인 인증기관 : 웹와치"><img src="http://hpimg.gsretail.com/_ui/desktop/common/images/gscvs/common/btm_mark01.jpg" alt="미래창조과학부 WEB ACCESSIBILITY 마크(웹 접근성 품질인증 마크)"></a></li>
				</ul>
		</div>
	</div>
</div>
