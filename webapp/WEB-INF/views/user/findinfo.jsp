...
<title>회원정보 찾기</title>
<link href="/smartcan/assets/css/login.css" rel="stylesheet"
	type="text/css">
</head>
<body>
	...
	<div class="container">
		...
		<div id="title1_p">
			...
			<p>
				<em id="emphasis">smartcan</em>회원이실 경우, 각 해당란에 모두 기입해주십시오.
			</p>
		</div>
				...
				<form id="id-form" name="idForm" method="post"
					...
					<table class="tbl_wtype1 smaller">
						<tbody>
							...
							<tr>
								<th scope="row">성별</th>
								<td><label>남</label> <input type="radio" id="gemder"
									name="gender" value="MALE" checked="checked"> <label>여</label>
									<input type="radio" id="gemder" name="gender" value="FEMALE">
								</td>
							</tr>
							<tr>
				...
				<form id="password-form" name="passForm" method="post">
					<table class="tbl_wtype1 smaller">
						<tbody>
							...
							<tr>
								<th scope="row" class="">생년월일</th>
								<td><input id="birth1" name="birth" type="text" value=""
									placeholder="Ex.19901212"></td>
							</tr>
							<tr>
								<th scope="row">휴대폰</th>
								<td><input id="phone1" name="phone" type="text" value=""
									placeholder="'-'제외하고 숫자만 입력"></td>
							</tr>
						</tbody>
					</table>
