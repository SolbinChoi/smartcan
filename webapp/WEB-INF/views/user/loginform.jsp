...
<link rel="stylesheet" type="text/css"
	href="/smartcan/assets/css/sweetalert.css">
	...
	<div class="container">
		...
		<div id="contents">
			<div id="user">
				<div id="log-border">
					<p id="title">
						<em>Smart Can</em> <em style="color: blue">로그인</em>
					</p>
					<p id="intro">
						Smart Can에 가입하신<br> 아이디와 비밀번호로 로그인 하실 수 있습니다.
					</p>
			...
			<div id="findMember">
				<div id="joincan">
					...
					<a href="/smartcan/user/joinform" class="btn btn_arr wt"
						id="canbtn1">회원가입</a>
				</div>
				<div id="findcan">
					<p>
		...
		$("#btn_Login").on("click", function() {
			...
			$.ajax({
				...
				success : function(result) { 
					//비동기식으로 진행되어 결과와 상관 없이 submit되므로 계속 refres됨(따로 동기식으로 변경해야함)
					console.log(result);
					if (result == "false") {
						console.log(result);
